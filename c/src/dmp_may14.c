...
int init_params()
{
  ...
  double best[NP];
        ...
        best[2]=0.3750000001   ;
        best[3]=0.6499999999   ;
        best[4]=0.09965494991  ;
        best[5]=0.5338223417   ;
        best[6]=6.530948976    ;
        best[7]=0.05976085056  ;
        best[8]=0.9283862556   ;
        best[9]=4.25           ;
        best[10]=33.85337511    ;
        best[11]=0.004933528686 ;
        best[12]=1.016229791    ;
        best[13]=0.8500000001   ;
        best[14]=3.933364892    ;
        best[15]=2.986111834    ;
        best[16]=11.35449181    ;
        best[17]=-0.1284755903  ;
        best[18]=15             ;
        best[19]=-0.1776365934  ;
...
int main(int argc, char * argv[])
{
  ...
  //calibrate parameters
  else if(calibrate==1)
    {
      ...
      nlopt_opt opt = nlopt_create(NLOPT_G_MLSL_LDS, NP);
